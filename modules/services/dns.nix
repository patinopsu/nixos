    ...
    sops = {
      ...
      templates."nextdns-resolved.conf" = {
        ...
        content = ''
          [Resolve]
          DNSOverTLS=yes
          DNS=45.90.28.0#${config.vars.prettyname}-${config.sops.placeholder.nextdns}.dns.nextdns.io
          DNS=45.90.30.0#${config.vars.prettyname}-${config.sops.placeholder.nextdns}.dns.nextdns.io
          Domains=~.
        '';
      };
    };
